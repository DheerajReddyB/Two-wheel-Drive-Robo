...
int trigPin = 5;
int echoPin = 6;
int rightMotorPin1 = 7;//9
int rightMotorPin2 = 8;//8

int leftMotorPin1 = 9;//7
int leftMotorPin2 = 10;//10
...
if ((distance > 20))
  {
    Serial.println("20000000");
    digitalWrite(7, LOW);                              //       If you dont get proper movements of your robot,
    digitalWrite(8, HIGH);                              //        then alter the pin numbers
    digitalWrite(9, HIGH);                              //
    digitalWrite(10, LOW);                             //
  }
  else if (distance < 18)
